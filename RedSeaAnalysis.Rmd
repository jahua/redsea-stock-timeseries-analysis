...
# Display correlation change summary statistics
...
if (!requireNamespace("rugarch", quietly = TRUE)) {
  ...
  assets_to_analyze <- c(data$shipping_cols[1], data$market_cols[1]) # First shipping stock and market index
  ...
  if (length(garch_vols) > 0) {
    ...
    formatted_kable(persistence_results, "GARCH Volatility Persistence", digits = 4)
  }
}
```
